...
const ar: Translation = {
  ...
  header: {
    ...
    description: "مرحبًا، أنا مطور برمجيات متكامل بخبرة تزيد عن 5 سنوات في بناء تطبيقات الويب القابلة للتطوير وعالية الأداء. أتخصص في روبي أون ريلز للواجهة الخلفية وأستخدم أطر العمل الحديثة مثل React وNext.js وAngular للواجهة الأمامية. أساعد في تحويل الأفكار إلى حلول نظيفة وقابلة للصيانة وفعالة.",
  },
    ...
    items: [
      {
        ...
        description_2: `حاليًا، أعمل على مشروع المركز السعودي لكفاءة الطاقة (SEEC)، حيث أتحمل مسؤولية إضافة قصص وميزات جديدة للموقع من الصفر. يتضمن ذلك تنفيذ جداول البيانات مع عمليات CRUD، وضمان إدارة البيانات بكفاءة، وتحسين قابلية الاستخدام الشاملة للمنصة. من خلال التركيز على تحسين الأداء وتوسيع الميزات، أساهم في تحسين تجربة المستخدم ووظائف النظام.`,
      },
      {
